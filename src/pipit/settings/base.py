...
DATABASES = {
    "default": {
        ...
        "NAME": get_env("DATABASE_NAME",default="postgres", required=True),
        "USER": get_env("DATABASE_USER",default="postgres.psdgbgkaddgerjihiosf", required=True),
        "PASSWORD": get_env("DATABASE_PASSWORD",default="jijze5-gaqgut-cYfhuc", required=True),
        "HOST": get_env("DATABASE_HOST",default="aws-0-ap-south-1.pooler.supabase.com", required=True),
...
# Wagtail
WAGTAIL_SITE_NAME = "Speed Wings Human Resource"
...
GRAPHENE = {
    ...
    "MIDDLEWARE": ["grapple.middleware.GrappleMiddleware","graphql_jwt.middleware.JSONWebTokenMiddleware",],
...
GRAPPLE = {
    "APPS": ["main","jobs","customimage","customdocument","customuser","graphql_auth"],
    "ADD_SEARCH_HIT": True,
